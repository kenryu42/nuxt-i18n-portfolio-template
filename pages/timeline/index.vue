        ...
        <div class="relative mt-5 text-left dark:text-gray-400">
          ...
          <div class="flex items-center relative" data-aos="fade-up">
            ...
            <div class="ml-10">
              ...
              <div class="mb-4 mt-2 md:hidden">
                ...
                <div class="text-xs">February.</div>
              </div>
              <div class="mb-10">
                {{ $t('timeline_desc') }}
              </div>
          ...
          <div class="flex items-center relative" data-aos="fade-up">
            ...
            <div class="ml-10">
              ...
              <div class="mb-4 mt-2 md:hidden">
                <div class="font-bold">2005</div>
                <div class="text-xs">October.</div>
              </div>
              <div class="mb-10">
                {{ $t('timeline_desc') }}
              </div>
...
export default Vue.extend({
  head(): Title {
    return {
      title: this.$i18n.t('timeline') + ' - Your_Name',
    }
  },
})
</script>
